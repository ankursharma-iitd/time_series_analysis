...
from mandi import specificarrivalseries
from mandi import specificpriceseries

from retail import retailpriceseries
...
from retail import specificretailprice
from retail import expectedretailprice
...
startplot = CONSTANTS['STARTDATE']
endplot = CONSTANTS['ENDDATE']

plotarrival(startplot, endplot, False, True)
plotmandiprice(startplot, endplot, False, True)
plotretailprice(startplot, endplot, False, True)
plotretailvsmandi(startplot, endplot, True, True)
plotsingleseries(retailpriceseries - mandipriceseries,'Difference','Time','Price per Quintal',startplot, endplot, False, True)
